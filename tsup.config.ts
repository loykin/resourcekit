...
export default defineConfig({
  entry: {
    ...
    'adapters/rjsf': 'src/adapters/rjsf/index.ts',
  ...
  sourcemap: true,
  clean:     true,
  external:  ['react', 'react-dom', 'react-hook-form', '@loykin/designkit', '@loykin/gridkit', '@loykin/chartkit', '@loykin/filter-input', '@loykin/datasourcekit', '@tanstack/query-core', '@rjsf/core', '@rjsf/utils', '@rjsf/validator-ajv8'],
  treeshake: true,
})
